...
{
  "$end", "error", "$undefined", "OBRACKET", "CBRACKET", "NEWLINE",
  "WORD", "PIPE", "FORCEOUTADD", "FORCEOUT", "FORCEIN", "AND", "OR",
  "BACKGROUND", "NEXT", "$accept", "simpleCommand", YY_NULLPTR
};
#endif
...
#line 1237 "y.tab.c" /* yacc.c:1646  */
  ...
  case 4:
#line 63 "example1.y" /* yacc.c:1646  */
    { 
			   printf("%s\n",(yyvsp[0]));
...
#line 75 "example1.y" /* yacc.c:1906  */
